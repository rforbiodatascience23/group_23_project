...
#| eval: true
#| echo: false
ggsave("../results/normalized_TNBC_across_menopausal.png", plot = last_plot(), device = "png", bg="white")
```
...
#| eval: true
#| echo: false
ggsave("../results/ER_PR_across_age_groups.png", plot = last_plot(), device = "png", bg="white")
```

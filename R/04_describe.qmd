...
As expected, the great majority of samples were taken from female patients, since according to the World Health Organization (WHO), only approximately 0.5-1% of breast cancers occur in men (data from 12 jul 2023). Three of the samples are not classified either as male or female.

### 04.2.2. Age at initial pathological diagnosis distribution

This was previously discussed in the augmentation file for dividing the samples in age ranges, but here we will focus more in the mean and other statistically relevant data.

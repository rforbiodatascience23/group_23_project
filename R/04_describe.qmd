...
In the data augmentation section, the samples were grouped together by age, into 6 age groups. The age distribution amongs samples is shown in the histogram below, there are individuals for all intervals, even if some contain far more samples than others.

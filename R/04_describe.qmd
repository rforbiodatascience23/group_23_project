...
### 04.2.10. Node distribution across menopausal age groups
...
We can see that the presence of nearby lymph nodes that have cancer does not seem to be dependent on the age, since all three age groups apparently have a similair distribution of "Positives" and "Negatives" for this variable.
